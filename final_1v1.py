...
max_rate = 0
for key1 in loaded_result.keys():
    win_rate = len(loaded_result[key1]['player1_wins'])/(len(loaded_result[key1]['player1_wins'])+len(loaded_result[key1]['player2_wins']))
    output_result[key1] = win_rate
...
with open("final_results/1v1.json", "w") as f:
